...
const ContentDetail: React.FC<ContentDetailProps> = ({
  ...
  return (
    <div
      className={`fixed top-1.5 right-1.5 bottom-1.5 left-[calc(4rem+6px)] bg-white z-50 transform transition-transform duration-500 ease-in-out rounded-2xl shadow-sm border border-gray-200 ${
